        ...
        <div id="wpjobportal-admin-wrapper">
            <form id="wpjobportal-form" class="wpjobportal-form" method="post" action="<?php echo esc_url(admin_url("admin.php?page=wpjobportal_fieldordering&task=saveuserfield")); ?>">
                ...
                <div class="wpjobportal-form-button">
                    <a id="form-cancel-button" class="wpjobportal-form-cancel-btn" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_fieldordering&ff='.$_GET['ff'])); ?>" title="<?php echo esc_html(__('Cancel', 'wp-job-portal')); ?>"><?php echo esc_html(__('Cancel', 'wp-job-portal')); ?></a>
        ...
        <?php
            $inline_js_script = "
                ...
                function getNextField(divid,object) {
                    var textvar = divid + '[]';
                    var fieldhtml = \"<span class='input-field-wrapper' ><input type='text' name='\" + textvar + \"' class='inputbox one user-field'  /><img class='input-field-remove-img' src='". WPJOBPORTAL_PLUGIN_URL."includes/images/remove.png' /></span>\";
                ...
                function insertNewRow() {
                    var fieldhtml = '<span class=\"input-field-wrapper\" ><input name=\"values[]\" id=\"values[]\" value=\"\" class=\"inputbox one user-field\" type=\"text\" /><img class=\"input-field-remove-img\" src=\"". WPJOBPORTAL_PLUGIN_URL."includes/images/remove.png\" /></span>';
