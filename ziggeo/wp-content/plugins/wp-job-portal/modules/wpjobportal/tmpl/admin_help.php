        ...
        <div id="wpjobportal-admin-wrapper" class="p0 bg-n bs-n">
            ...
            <div class="wpjobportal-help-top">
                <div class="wpjobportal-help-top-left">
                    <div class="wpjobportal-help-top-left-cnt-img">
                        <img alt="<?php echo esc_html(__('Help icon','wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/help-page/support-icon.jpg" />
                    </div>
                    <div class="wpjobportal-help-top-left-cnt-info">
                        <h2><?php echo esc_html(__('We are here to help you','wp-job-portal')); ?></h2>
                        <p><?php echo esc_html(__('WP Job Portal is a simple yet powerful Jobs Board plugin that provides a Step-by-step Youtube guide for its ease of use.','wp-job-portal')); ?></p>
                        <a href="https://www.youtube.com/channel/UCk_qYTzV6gusKmMHxTrgU2Q" target="_blank" class="wpjobportal-help-top-middle-action" title="<?php echo esc_html(__('View all videos','wp-job-portal')); ?>"><img alt="<?php echo esc_html(__('Video icon','wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/help-page/play-icon.jpg" /><?php echo esc_html(__('View All Videos','wp-job-portal')); ?></a>
                    </div>
                </div>
                <div class="wpjobportal-help-top-right">
                    <div class="wpjobportal-help-top-right-cnt-img">
                        <img alt="<?php echo esc_html(__('WP JOB PORTAL icon','wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/help-page/support.png" />
                    </div>
                    <div class="wpjobportal-help-top-right-cnt-info">
                        <h2><?php echo esc_html(__('WP Job Portal Support','wp-job-portal')); ?></h2>
                        <p><?php echo esc_html(__("WP Job Portal delivers timely customer support if you have any query then we're here to show you the way.",'wp-job-portal')); ?></p>
                        <a target="_blank" href="https://wpjobportal.com/support/" class="wpjobportal-help-top-middle-action second" title="<?php echo esc_html(__('Submit ticket','wp-job-portal')); ?>"><img alt="<?php echo esc_html(__('Video icon','wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/help-page/ticket.png" /><?php echo esc_html(__('Submit Ticket','wp-job-portal')); ?></a>
                    </div>
                </div>
            </div>
            <div class="wpjobportal-help-btm">
                ...
                <div class="wpjobportal-help-btm-wrp">
                    <h2 class="wpjobportal-help-btm-title"><?php echo esc_html(__('Job Portal','wp-job-portal')); ?></h2>
                    <?php
                ...
                <!-- misc -->
                <div class="wpjobportal-help-btm-wrp">
                    <h2 class="wpjobportal-help-btm-title"><?php echo esc_html(__('Misc','wp-job-portal')); ?></h2>
                    <?php
                        ...
                        $title = esc_html(__('Export', 'wp-job-portal'));
                        $url = 'G-uwkNg5Za4';
                        printVideoPlaylist($title, $url);
                        ...
                        $title = esc_html(__('Credit Pack', 'wp-job-portal'));
                        $url = 'tAipI3jNl60';
                        printVideoPlaylist($title, $url);
