...
<div id="wpjobportaladmin-wrapper">
    ...
    <span class="js-admin-title">
        ...
        <a class="js-button-link button" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_fieldordering&wpjobportallt=formuserfield')); ?>"><img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/add_icon.png" /><?php echo esc_html(__('Add User Field', 'wp-job-portal')) ?></a>
    </span>
    <div class="page-actions js-row no-margin">
        <a class="js-bulk-link button multioperation" message="<?php echo esc_attr(WPJOBPORTALMessages::getMSelectionEMessage()); ?>" data-for="remove" confirmmessage="<?php echo esc_html(__('Are you sure to delete', 'wp-job-portal')) .' ?'; ?>"  href="#"><img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/delete-icon.png" /><?php echo esc_html(__('Delete', 'wp-job-portal')) ?></a>
    </div>
    <?php
                ...
                <tbody>
                    ...
                    for ($i = 0, $n = count(wpjobportal::$_data[0]); $i < $n; $i++) {
                        ...
                        <tr valign="top">
                            ...
                            <td class="left-row"><a href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_customfield&wpjobportallt=formuserfield&wpjobportalid='.$row->id)); ?>" title="<?php echo esc_html(__('user','wp-job-portal')); ?>"><?php echo esc_html($row->name); ?></a></td>
                            <td><?php echo esc_html($row->title); ?></td>
                            <td><?php echo esc_html($row->type); ?></td>
                            <td><img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/<?php echo esc_attr($required); ?>.png" alt="<?php echo esc_attr($requiredalt); ?>" title="<?php echo esc_attr($requiredalt); ?>" /></td>
                            <td><img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/<?php echo esc_attr($readonly); ?>.png" alt="<?php echo esc_attr($readonlyalt); ?>" title="<?php echo esc_attr($readonlyalt); ?>" /></td>
                            <td class="action">
                                <a href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_customfield&wpjobportallt=formuserfield&wpjobportalid='.$row->id)); ?>" title="<?php echo esc_html(__('Edit', 'wp-job-portal')); ?>"><img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/edit.png" alt="<?php echo esc_html(__('Edit', 'wp-job-portal')); ?>" title="<?php echo esc_html(__('Edit', 'wp-job-portal')); ?>"></a>
                                <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=wpjobportal_customfield&task=remove&action=wpjobportaltask&wpjobportal-cb[]='.$row->id),'delete-customfield')); ?>" onclick='return confirmdelete("<?php echo esc_html(__('Are you sure to delete', 'wp-job-portal')).' ?'; ?>");' title="<?php echo esc_html(__('Delete', 'wp-job-portal')); ?>"><img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/remove.png" alt="<?php echo esc_html(__('Delete', 'wp-job-portal')); ?>" title="<?php echo esc_html(__('Delete', 'wp-job-portal')); ?>"></a>
                            </td>
                        </tr>
                        <?php
                        $k = 1 - $k;
