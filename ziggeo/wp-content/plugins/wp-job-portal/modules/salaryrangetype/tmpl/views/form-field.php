...
<div class="wpjobportal-form-wrapper">
    ...
    <div class="wpjobportal-form-value">
    	<?php echo WPJOBPORTALformfield::radiobutton('isdefault', array('1' => esc_html(__('Yes', 'wp-job-portal')), '0' => esc_html(__('No', 'wp-job-portal'))), isset(wpjobportal::$_data[0]->isdefault) ? wpjobportal::$_data[0]->isdefault : 0, array('class' => 'radiobutton'),WPJOBPORTAL_ALLOWED_TAGS); ?>
    </div>
</div>
...
<div class="wpjobportal-form-button">
    <a id="form-cancel-button" class="wpjobportal-form-cancel-btn" href="<?php echo admin_url('admin.php?page=wpjobportal_salaryrangetype'); ?>" title="<?php echo esc_html(__('cancel', 'wp-job-portal')); ?>">
