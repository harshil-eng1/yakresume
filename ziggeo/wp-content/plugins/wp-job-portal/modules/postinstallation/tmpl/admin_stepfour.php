...
<?php
wp_enqueue_script( 'tokeninput', WPJOBPORTAL_PLUGIN_URL.'includes/js/jquery.tokeninput.js', array(), '', false );
wp_enqueue_script( 'chosen', WPJOBPORTAL_PLUGIN_URL.'includes/js/chosen/chosen.jquery.min.js', array(), '', false );
        ...
        <div class="wpjobportal-post-data">
            ...
            <form id="wpjobportal-form-ins" class="wpjobportal-form" method="post" action="<?php echo admin_url("admin.php?page=wpjobportal_postinstallation&task=savesampledata"); ?>">
                ...
                <div class="wpjobportal-post-action-btn">
                    <a class="back-step wpjobportal-post-act-btn" href="<?php echo admin_url('admin.php?page=wpjobportal_postinstallation&wpjobportallt=stepthree'); ?>" title="<?php echo esc_html(__('back','wp-job-portal')); ?>">
