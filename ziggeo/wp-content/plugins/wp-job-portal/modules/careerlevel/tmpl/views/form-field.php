...
?>
    ...
    <div class="wpjobportal-form-button">
        <a id="form-cancel-button" class="wpjobportal-form-cancel-btn" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_careerlevel')); ?>" title="<?php echo esc_html(__('cancel', 'wp-job-portal')); ?>">
