...
<ul class="wpjobportaladmin-sidebar-menu tree" data-widget="tree" id="accordion">
    <li class="treeview <?php if( ($c == 'wpjobportal' && $layout != 'themes' && $layout != 'shortcodes' && $layout != 'addonstatus') || $c == 'wpjobportal_activitylog' || $c == 'wpjobportal_systemerror' || $c == 'wpjobportal_slug' ) echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal" title="<?php echo esc_html(__('dashboard' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('dashboard' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/dashboard.png'; ?>" />
    ...
    <li class="treeview <?php if($c == 'wpjobportal_configuration' || $c == 'wpjobportal_paymentmethodconfiguration' || $c == 'wpjobportal_cronjob' ) echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal_configuration" title="<?php echo esc_html(__('configuration' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('configuration' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/config.png'; ?>" />
            <span class="wpjobportaladmin-text">
    ...
    <li class="treeview <?php if($c == 'wpjobportal_theme') echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal_theme" title="<?php echo esc_html(__('colors' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('colors' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/theme.png'; ?>" />
            <span class="wpjobportaladmin-text">
    ...
    <li class="treeview <?php if($c == 'wpjobportal_premiumplugin') echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal_premiumplugin" title="<?php echo esc_html(__('ad ons' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('ad ons' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/ad-ons.png'; ?>" />
            <span class="wpjobportaladmin-text">
    ...
    <li class="treeview <?php if($c == 'wpjobportal' && $layout == 'addonstatus') echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal&wpjobportallt=addonstatus" title="<?php echo esc_html(__('addons status' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('addons status' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/addon-status.png'; ?>" />
            <span class="wpjobportaladmin-text">
    ...
    <li class="treeview <?php if(($c == 'wpjobportal_company' || ($c == 'wpjobportal_fieldordering' && $ff == 1)) ) echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal_company" title="<?php echo esc_html(__('companies' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('companies' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/companies.png'; ?>" />
            <span class="wpjobportaladmin-text">
    ...
    <?php if(in_array('departments', wpjobportal::$_active_addons)){ ?>
        <li class="treeview <?php if($c == 'wpjobportal_departments') echo 'active'; ?>">
            <a href="admin.php?page=wpjobportal_departments" title="<?php echo esc_html(__('departments' , 'wp-job-portal')); ?>">
                <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('departments' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/department.png'; ?>" />
                <span class="wpjobportaladmin-text">
    ...
    <?php }else{
        ...
        <li class="treeview">
            <a href="javascript: void(0);" title="<?php echo esc_html(__('departments' , 'wp-job-portal')); ?>">
                <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('departments' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/grey-menu/department.png'; ?>" />
    ...
    <li class="treeview <?php if($c == 'wpjobportal_job' || $c == 'wpjobportal_jobapply' || $c == 'wpjobportal_jobalert' || $c == 'wpjobportal_customfield' || ($c == 'wpjobportal_fieldordering' && $ff == 2)) echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal_job" title="<?php echo esc_html(__('jobs' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('jobs' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/jobs.png'; ?>" />
            <span class="wpjobportaladmin-text">
    ...
    <?php if(in_array('coverletter', wpjobportal::$_active_addons)){ ?>
        <li class="treeview <?php if($c == 'wpjobportal_coverletter') echo 'active'; ?>"  style="display: none;">
            <a href="admin.php?page=wpjobportal_coverletter" title="<?php echo esc_html(__('coverletters' , 'wp-job-portal')); ?>">
                <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('coverletters' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/cover-letter.png'; ?>" />
                <span class="wpjobportaladmin-text">
    ...
    <?php }else{
        ...
        <li class="treeview">
            <a href="javascript: void(0);" title="<?php echo esc_html(__('coverletter' , 'wp-job-portal')); ?>">
                <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('coverletter' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/grey-menu/cover-letter.png'; ?>" />
    ...
    <li class="treeview <?php if($c == 'wpjobportal_resume' ||  ($c == 'wpjobportal_fieldordering' && $ff == 3)) echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal_resume" title="<?php echo esc_html(__('resume' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('resume' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/resume.png'; ?>" />
            <span class="wpjobportaladmin-text">
        ...
        if(in_array('message', wpjobportal::$_active_addons)){
            ...
            <li class="treeview">
                <a href="javascript: void(0);" title="<?php echo esc_html(__('Message' , 'wp-job-portal')); ?>">
                    <img src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/grey-menu/message.png'; ?>" alt="<?php echo esc_html(__('message' , 'wp-job-portal')); ?>" class="wpjobportaladmin-menu-icon">
        ...
        if(in_array('credits', wpjobportal::$_active_addons)){
            ...
            <li class="treeview">
                <a href="javascript: void(0);" title="<?php echo esc_html(__('Credits' , 'wp-job-portal')); ?>">
                    <img src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/grey-menu/credits.png'; ?>" alt="<?php echo esc_html(__('credits' , 'wp-job-portal')); ?>" class="wpjobportaladmin-menu-icon">
        ...
        if(in_array('folder', wpjobportal::$_active_addons)){
            ...
            <li class="treeview">
                <a href="javascript: void(0);" title="<?php echo esc_html(__('Folder' , 'wp-job-portal')); ?>">
                    <img src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/grey-menu/folders.png'; ?>" alt="<?php echo esc_html(__('folder' , 'wp-job-portal')); ?>" class="wpjobportaladmin-menu-icon">
    ...
    <li class="treeview <?php if($c == 'wpjobportal_jobtype') echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal_jobtype" title="<?php echo esc_html(__('job types' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('job types' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/job-types.png'; ?>" />
            <span class="wpjobportaladmin-text">
    ...
    <li class="treeview <?php if($c == 'wpjobportal_jobstatus') echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal_jobstatus" title="<?php echo esc_html(__('job status' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('job status' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/status.png'; ?>" />
            <span class="wpjobportaladmin-text">
    ...
    <?php /*<li class="treeview <?php if($c == 'wpjobportal_shift') echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal_shift" title="<?php echo esc_html(__('shifts' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('shifts' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/job-shifts.png'; ?>" />
            <span class="wpjobportaladmin-text">
    ...
    <li class="treeview <?php if($c == 'wpjobportal_highesteducation') echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal_highesteducation" title="<?php echo esc_html(__('highest educations' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('highest educations' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/highest-education.png'; ?>" />
            <span class="wpjobportaladmin-text">
    ...
    <?php /*<li class="treeview <?php if($c == 'wpjobportal_age') echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal_age" title="<?php echo esc_html(__('ages' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('ages' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/ages.png'; ?>" />
            <span class="wpjobportaladmin-text">
    ...
    <li class="treeview <?php if($c == 'wpjobportal_careerlevel') echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal_careerlevel" title="<?php echo esc_html(__('career levels' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('career levels' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/career-levels.png'; ?>" />
            <span class="wpjobportaladmin-text">
    ...
    <li class="treeview <?php if($c == 'wpjobportal_currency') echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal_currency" title="<?php echo esc_html(__('currency' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('currency' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/currency.png'; ?>" />
            <span class="wpjobportaladmin-text">
    ...
    <li class="treeview <?php if($c == 'wpjobportal_category') echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal_category" title="<?php echo esc_html(__('resume' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('categories' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/category.png'; ?>" />
            <span class="wpjobportaladmin-text">
        ...
        if(in_array('tag', wpjobportal::$_active_addons)){
            ...
            <li class="treeview">
                <a href="javascript: void(0);" title="<?php echo esc_html(__('Tags' , 'wp-job-portal')); ?>">
                    <img src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/grey-menu/tags.png'; ?>" alt="<?php echo esc_html(__('tags' , 'wp-job-portal')); ?>" class="wpjobportaladmin-menu-icon">
    ...
    <li class="treeview <?php if($c == 'wpjobportal_salaryrange' || $c == 'wpjobportal_salaryrangetype' ) echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal_salaryrangetype" title="<?php echo esc_html(__('salary range' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('salary range' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/salary-range.png'; ?>" />
            <span class="wpjobportaladmin-text">
    ...
    <li class="treeview <?php if($c == 'wpjobportal_user' || $c == 'wpjobportal_customfield' || ($c == 'wpjobportal_fieldordering' && ($layout == '') && $ff == 4)) echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal_user" title="<?php echo esc_html(__('users' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('users' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/users.png'; ?>" />
            <span class="wpjobportaladmin-text">
    ...
    <li class="treeview <?php if($c == 'wpjobportal' && $layout == 'shortcodes' ) echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal&wpjobportallt=shortcodes" title="<?php echo esc_html(__('short codes' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('short codes' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/short-codes.png'; ?>" />
            <span class="wpjobportaladmin-text">
    ...
    <li class="treeview <?php if($c == 'wpjobportal_report' || ($c == 'wpjobportal_reports')) echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal_report&wpjobportallt=overallreports" title="<?php echo esc_html(__('reports' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('reports' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/reports.png'; ?>" />
            <span class="wpjobportaladmin-text">
    ...
    <li class="treeview <?php if($c == 'wpjobportal_emailtemplate' || $c == 'wpjobportal_emailtemplatestatus') echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal_emailtemplate" title="<?php echo esc_html(__('email templates' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('email templates' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/email-templates.png'; ?>" />
            <span class="wpjobportaladmin-text">
    ...
    <li class="treeview <?php if($c == 'wpjobportal_country' || $c == 'wpjobportal_addressdata' || $c == 'wpjobportal_state' || $c == 'wpjobportal_city') echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal_country" title="<?php echo esc_html(__('countries' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('countries' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/address-data.png'; ?>" />
            <span class="wpjobportaladmin-text">
    ...
    <li class="treeview <?php if($c == 'wpjobportal' && $layout == 'help' ) echo 'active'; ?>">
        <a href="admin.php?page=wpjobportal&wpjobportallt=help" title="<?php echo esc_html(__('help' , 'wp-job-portal')); ?>">
            <img class="wpjobportaladmin-menu-icon" alt="<?php echo esc_html(__('help' , 'wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/admin-left-menu/help.png'; ?>" />
            <span class="wpjobportaladmin-text">
