...
<div class="wpjobportal-form-button">
    <a id="form-cancel-button" class="wpjobportal-form-cancel-btn" href="<?php echo admin_url('admin.php?page=wpjobportal_city&countryid='.$countryid); ?>&stateid=<?php echo esc_url($stateid); ?>" title="<?php echo esc_html(__('cancel', 'wp-job-portal')); ?>">
