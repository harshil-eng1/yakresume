		...
		switch ($layouts) {
			case 'controlpanel':
				$html.='<h1 class="wpjobportal-head-text">'. esc_html(__('Dashboard', 'wp-job-portal')).'</h1>
	        			<a class="wpjobportal-add-link orange-bg button" href="admin.php?page=wpjobportal_job&wpjobportallt=formjob" title="'. esc_html(__('add job','wp-job-portal')).'">
	        				<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/plus-icon.png" alt="'. esc_html(__('plus icon','wp-job-portal')).'" />
	        			...
	        			<a class="wpjobportal-add-link button" href="admin.php?page=wpjobportal_job" title="'. esc_html(__('all jobs','wp-job-portal')).'">
	        				<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/all-jobs.png" alt="'. esc_html(__('all jobs','wp-job-portal')).'" />
			...
			case 'jobtype':
				$html.='<h1 class="wpjobportal-head-text">'. esc_html(__('Job Types', 'wp-job-portal')).'</h1>
	        			<a class="wpjobportal-add-link button" href='.admin_url('admin.php?page=wpjobportal_jobtype&wpjobportallt=formjobtype').' title="'. esc_html(__('add new job type','wp-job-portal')).'">
	        				<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/plus-icon.png" alt="'. esc_html(__('plus icon','wp-job-portal')).'" />
			...
			case 'slug':
				$html.='<h1 class="wpjobportal-head-text">'. esc_html(__('Slug', 'wp-job-portal')).'</h1>
	        			<a class="wpjobportal-add-link button" href='.admin_url('admin.php?page=wpjobportal_slug&task=resetallslugs&action=wpjobportaltask').' title="'. esc_html(__('reset all','wp-job-portal')).'">
			...
			case 'shift':
				$html.='<h1 class="wpjobportal-head-text">'. esc_html(__('Shifts', 'wp-job-portal')).'</h1>
	        			<a class="wpjobportal-add-link button" href='.admin_url('admin.php?page=wpjobportal_shift&wpjobportallt=formshift').' title="'. esc_html(__('add new shift','wp-job-portal')).'">
	        				<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/plus-icon.png" alt="'. esc_html(__('plus icon','wp-job-portal')).'" />
			...
			case 'age':
				$html.='<h1 class="wpjobportal-head-text">'. esc_html(__('Age', 'wp-job-portal')).'</h1>
	        			<a class="wpjobportal-add-link button" href='.admin_url('admin.php?page=wpjobportal_age&wpjobportallt=formages').' title="'. esc_html(__('add new age','wp-job-portal')).'">
	        				<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/plus-icon.png" alt="'. esc_html(__('plus icon','wp-job-portal')).'" />
			...
			case 'experience':
				$html.='<h1 class="wpjobportal-head-text">'. esc_html(__('Experiences', 'wp-job-portal')).'</h1>
	        			<a class="wpjobportal-add-link button" href='. admin_url('admin.php?page=wpjobportal_experience&wpjobportallt=formexperience').' title="'. esc_html(__('add new experience','wp-job-portal')).'">
	        				<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/plus-icon.png" alt="'. esc_html(__('plus icon','wp-job-portal')).'" />
			...
			case 'currency':
				$html.='<h1 class="wpjobportal-head-text">'. esc_html(__('Currency', 'wp-job-portal')).'</h1>
	        			<a class="wpjobportal-add-link button" href='. admin_url('admin.php?page=wpjobportal_currency&wpjobportallt=formcurrency').' title="'. esc_html(__('add new currency','wp-job-portal')).'">
	        				<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/plus-icon.png" alt="'. esc_html(__('plus icon','wp-job-portal')).'" />
			...
			case 'jobalert':
				$html.='<h1 class="wpjobportal-head-text">'. esc_html(__('Job Alert', 'wp-job-portal')).'</h1>
	        			<a class="wpjobportal-add-link button" href='. admin_url('admin.php?page=wpjobportal_jobalert&wpjobportallt=formjobalert').' title="'. esc_html(__('add new job alert','wp-job-portal')).'">
	        				<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/plus-icon.png" alt="'. esc_html(__('plus icon','wp-job-portal')).'" />
			...
			case 'department':
				$html.='<h1 class="wpjobportal-head-text">'. esc_html(__('Departments', 'wp-job-portal')) .'</h1>
			        	<a class="wpjobportal-add-link button" href='. admin_url('admin.php?page=wpjobportal_departments&wpjobportallt=formdepartment').' title="'. esc_html(__('add new department','wp-job-portal')).'">
			        		<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/plus-icon.png" alt="'. esc_html(__('plus icon','wp-job-portal')).'" />
			...
			case 'company':
				$html.='<h1 class="wpjobportal-head-text">'.esc_html(__('Companies', 'wp-job-portal')).'</h1>
	    				<a class="wpjobportal-add-link button" href='. admin_url('admin.php?page=wpjobportal_company&wpjobportallt=formcompany').' title="'. esc_html(__('add new company','wp-job-portal')).'">
	    					<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/plus-icon.png" alt="'. esc_html(__('plus icon','wp-job-portal')).'" />
			...
			case 'joblist':
				$html.='<h1 class="wpjobportal-head-text">'. esc_html(__('Jobs', 'wp-job-portal')) .'</h1>
	        			<a class="wpjobportal-add-link button" href='. admin_url('admin.php?page=wpjobportal_job&wpjobportallt=formjob').' title="'.esc_html(__('add new job','wp-job-portal')).'">
	        				<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/plus-icon.png" alt="'. esc_html(__('plus icon','wp-job-portal')).'" />
			...
			case 'careerlevel':
	            ...
	            $html.='<a class="wpjobportal-add-link button" href='.admin_url('admin.php?page=wpjobportal_careerlevel&wpjobportallt=formcareerlevels').' title="'. esc_html(__('add new career level','wp-job-portal')).'">
	            			<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/plus-icon.png" alt="'. esc_html(__('plus icon','wp-job-portal')).'" />
	    	...
	    	case 'categories':
	        	...
	        	$html.='<a class="wpjobportal-add-link button" href='. admin_url('admin.php?page=wpjobportal_category&wpjobportallt=formcategory').' title="'. esc_html(__('add new category','wp-job-portal')).'">
	        				<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/plus-icon.png" alt="'. esc_html(__('plus icon','wp-job-portal')).'" />
			...
			case 'city':
				...
				$html.='<a class="wpjobportal-add-link button" href='.admin_url('admin.php?page=wpjobportal_city&wpjobportallt=formcity').' title="'. esc_html(__('add new city','wp-job-portal')).'">
							<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/plus-icon.png" alt="'. esc_html(__('plus icon','wp-job-portal')).'" />
			...
			case 'countries':
	            $html.='<h1 class="wpjobportal-head-text">'.esc_html(__('Countries', 'wp-job-portal')).'</h1>';
	         	$html.='<a class="wpjobportal-add-link button" href='.admin_url('admin.php?page=wpjobportal_country&wpjobportallt=formcountry').' title="'. esc_html(__('add new country','wp-job-portal')).'">
	         				<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/plus-icon.png" alt="'. esc_html(__('plus icon','wp-job-portal')).'" />
			...
			case 'highesteducation':
	            ...
	            $html.='<a class="wpjobportal-add-link button" href='. admin_url('admin.php?page=wpjobportal_highesteducation&wpjobportallt=formhighesteducation').' title="'. esc_html(__('add new education','wp-job-portal')).'">
	            			<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/plus-icon.png" alt="'. esc_html(__('plus icon','wp-job-portal')).'" />
			...
			case 'salaryrangetype':
	        	...
	        	$html.='<a class="wpjobportal-add-link button" href='. admin_url('admin.php?page=wpjobportal_salaryrangetype&wpjobportallt=formsalaryrangetype').' title="'. esc_html(__('add new salary range type','wp-job-portal')).'">
	        				<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/plus-icon.png" alt="'. esc_html(__('plus icon','wp-job-portal')).'" />
			...
			case 'state':
	    		...
	    		$html.='<a class="wpjobportal-add-link button" href='.admin_url('admin.php?page=wpjobportal_state&wpjobportallt=formstate').' title="'. esc_html(__('add new state','wp-job-portal')).'">
	    					<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/plus-icon.png" alt="'. esc_html(__('plus icon','wp-job-portal')).'" />
			...
			case 'users':
				$html.= '<h1 class="wpjobportal-head-text">'. esc_html(__('Users', 'wp-job-portal')) .'</h1>
					    <a class="wpjobportal-add-link button" href='. admin_url('admin.php?page=wpjobportal_user&wpjobportallt=assignrole').' title="'. esc_html(__('assign role', 'wp-job-portal')) .'">
					    	<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/plus-icon.png" alt="'. esc_html(__('plus icon','wp-job-portal')).'" />
			...
			case 'folder':
				...
				$html.='<a class="wpjobportal-add-link button" href='. admin_url('admin.php?page=wpjobportal_folder&wpjobportallt=formfolder').' title="'. esc_html(__('add new folder','wp-job-portal')).'">
							<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/plus-icon.png" alt="'. esc_html(__('plus icon','wp-job-portal')).'" />
			...
			case 'tags':
				$html .= '<h1 class="wpjobportal-head-text">'.esc_html(__('Tags', 'wp-job-portal')) .'</h1>
	        			<a class="wpjobportal-add-link button" href='. admin_url('admin.php?page=wpjobportal_tag&wpjobportallt=formtag') .' title="'. esc_html(__('add new tag','wp-job-portal')).'">
	        				<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/plus-icon.png" alt="'. esc_html(__('plus icon','wp-job-portal')).'" />
			...
			case 'package':
				...
				$html .= '<a class="wpjobportal-add-link" href='.admin_url('admin.php?page=wpjobportal_package&wpjobportallt=formpackage').' title="'. esc_html(__('add new package','wp-job-portal')).'">
							<img src="'.WPJOBPORTAL_PLUGIN_URL.'includes/images/control_panel/dashboard/plus-icon.png" alt="'. esc_html(__('plus icon','wp-job-portal')).'" />
