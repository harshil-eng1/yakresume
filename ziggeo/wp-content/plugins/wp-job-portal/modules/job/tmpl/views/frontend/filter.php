...
switch ($layout) {
	case 'myjobfilter':
	    $html.= esc_html(__("",'wp-job-portal')).'';
        ...
        // $html .= '</div>';
        // $html.= '   <div class="wjportal-filter-image">';
        // $html.= '       <a href='. wpjobportal::wpjobportal_makeUrl(array('wpjobportalme'=>'job', 'wpjobportallt'=>'myjobs','sortby' => wpjobportal::$_sortlinks['newest'], 'wpjobportalpageid'=>wpjobportal::wpjobportal_getPageid())) .' >';
        ...
        $html.= '    <a class="wjportal-act-btn" href='. wpjobportal::wpjobportal_makeUrl(array('wpjobportalme'=>'job', 'wpjobportallt'=>'addjob')).'> <i class="fa fa-plus"></i>'. esc_html(__('Add New Job', 'wp-job-portal')).'</a>
                </div>';
