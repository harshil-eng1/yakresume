            ...
            <form method="post" class="emailtemplateform" action="<?php echo esc_url(admin_url("?page=wpjobportal_emailtemplate&task=saveemailtemplate")); ?>">
                <div class="wpjobportal-email-menu">
                    <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'ew-cm') echo 'selected'; ?>">
                        <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=ew-cm')); ?>" title="<?php echo esc_html(__('new company', 'wp-job-portal')); ?>">
                    ...
                    <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'd-cm') echo 'selected'; ?>">
                        <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=d-cm')); ?>" title="<?php echo esc_html(__('delete company', 'wp-job-portal')); ?>">
                    ...
                    <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'cm-sts') echo 'selected'; ?>">
                        <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=cm-sts')); ?>" title="<?php echo esc_html(__('company status', 'wp-job-portal')); ?>">
                    ...
                    <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'ew-ob') echo 'selected'; ?>">
                        <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=ew-ob')); ?>" title="<?php echo esc_html(__('new job', 'wp-job-portal')); ?>">
                    ...
                    <?php if(in_array('visitorcanaddjob', wpjobportal::$_active_addons)){ ?>
                                <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'ew-obv') echo 'selected'; ?>">
                                    <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=ew-obv')); ?>" title="<?php echo esc_html(__('new visitor job', 'wp-job-portal')); ?>">
                    ...
                    <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'ob-sts') echo 'selected'; ?>">
                        <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=ob-sts')); ?>" title="<?php echo esc_html(__('job status', 'wp-job-portal')); ?>">
                    ...
                    <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'ob-d') echo 'selected'; ?>">
                        <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=ob-d')); ?>" title="<?php echo esc_html(__('job delete', 'wp-job-portal')); ?>">
                    ...
                    <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'ew-rm') echo 'selected'; ?>">
                        <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=ew-rm')); ?>" title="<?php echo esc_html(__('new resume', 'wp-job-portal')); ?>">
                    ...
                    <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'ew-rmv') echo 'selected'; ?>">
                        <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=ew-rmv')); ?>" title="<?php echo esc_html(__('new visitor resume', 'wp-job-portal')); ?>">
                    ...
                    <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'rm-sts') echo 'selected'; ?>">
                        <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=rm-sts')); ?>" title="<?php echo esc_html(__('resume status', 'wp-job-portal')); ?>">
                    ...
                    <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'd-rs') echo 'selected'; ?>">
                        <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=d-rs')); ?>" title="<?php echo esc_html(__('delete resume', 'wp-job-portal')); ?>">
                    ...
                    <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'em-n') echo 'selected'; ?>">
                        <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=em-n')); ?>" title="<?php echo esc_html(__('new employer', 'wp-job-portal')); ?>">
                    ...
                    <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'obs-n') echo 'selected'; ?>">
                        <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=obs-n')); ?>" title="<?php echo esc_html(__('new job seeker', 'wp-job-portal')); ?>">
                    ...
                    <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'ad-jap') echo 'selected'; ?>">
                        <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=ad-jap')); ?>" title="<?php echo esc_html(__('job apply admin', 'wp-job-portal')); ?>">
                    ...
                    <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'em-jap') echo 'selected'; ?>">
                        <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=em-jap')); ?>" title="<?php echo esc_html(__('job apply employer', 'wp-job-portal')); ?>">
                    ...
                    <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'js-jap') echo 'selected'; ?>">
                        <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=js-jap')); ?>" title="<?php echo esc_html(__('job apply job seeker', 'wp-job-portal')); ?>">
                    ...
                    <?php if(in_array('resumeaction', wpjobportal::$_active_addons)){ ?>
                        <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'ap-jap') echo 'selected'; ?>">
                            <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=ap-jap')); ?>" title="<?php echo esc_html(__('applied resume status change', 'wp-job-portal')); ?>">
                    ...
                    <?php } ?>
                     <?php if(in_array('resumeaction', wpjobportal::$_active_addons)){ ?>
                        <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'jb-at') echo 'selected'; ?>">
                            <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=jb-at')); ?>" title="<?php echo esc_html(__('job alert', 'wp-job-portal')); ?>">
                    ...
                    <?php } ?>
                     <?php if(in_array('tellfriend', wpjobportal::$_active_addons)){ ?>
                        <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'jb-to-fri') echo 'selected'; ?>">
                            <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=jb-to-fri')); ?>" title="<?php echo esc_html(__('tell to friend', 'wp-job-portal')); ?>">
                   ...
                   <?php if(in_array('credits', wpjobportal::$_active_addons)){ ?>
                    <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'ew-pk-ad') echo 'selected'; ?>">
                        <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=ew-pk-ad')); ?>" title="<?php echo esc_html(__('Purchase Package', 'wp-job-portal')).' '.esc_html(__(' Admin', 'wp-job-portal')); ?>">
                    ...
                    <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'ew-pk') echo 'selected'; ?>">
                        <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=ew-pk')); ?>" title="<?php echo esc_html(__('Purchase Package', 'wp-job-portal')); ?>">
                    ...
                    <span class="wpjobportal-email-menu-link <?php if (wpjobportal::$_data[1] == 'st-pk') echo 'selected'; ?>">
                        <a class="wpjobportal-email-link" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_emailtemplate&for=st-pk')); ?>" title="<?php echo esc_html(__('Purchase Status', 'wp-job-portal')); ?>">
