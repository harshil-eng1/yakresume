        ...
        <div id="wpjobportal-admin-wrapper" class="p0 bg-n bs-n">
            ...
            <div id="wpjobportal-page-quick-actions">
                <a class="wpjobportal-page-quick-act-btn multioperation" message="<?php echo esc_attr(WPJOBPORTALMessages::getMSelectionEMessage()); ?>" data-for="publish" href="#" title="<?php echo esc_html(__('publish', 'wp-job-portal')) ?>">
                    <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/control_panel/dashboard/good.png" alt="<?php echo esc_html(__('publish', 'wp-job-portal')) ?>" />
                ...
                <a class="wpjobportal-page-quick-act-btn multioperation" message="<?php echo esc_attr(WPJOBPORTALMessages::getMSelectionEMessage()); ?>" data-for="unpublish" href="#" title="<?php echo esc_html(__('unpublish', 'wp-job-portal')) ?>">
                    <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/control_panel/dashboard/close.png" alt="<?php echo esc_html(__('unpublish', 'wp-job-portal')) ?>" />
                                    ...
                                    for ($i = 0, $n = count(wpjobportal::$_data[0]); $i < $n; $i++) {
                                        ...
                                        <tr id="id_<?php echo esc_attr($row->id);?>">
                                            ...
                                            <td class="wpjobportal-order-grab-column">
                                               <img alt="<?php echo esc_html(__('grab','wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL . 'includes/images/list-full.png'?>"/>
                                            </td>
                                            <td>
                                                <a href="<?php echo admin_url('admin.php?page=wpjobportal_jobtype&wpjobportallt=formjobtype&wpjobportalid='.$row->id); ?>" title="<?php echo esc_html(__('job types','wp-job-portal')); ?>">
                                                    <?php echo esc_html(__(esc_html($row->title),'wp-job-portal')); ?>
                                                </a>
                                            </td>
                                            <td>
                                                <?php if ($row->isdefault == 1) { ?>
                                                    <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/default.png" alt="<?php echo esc_html(__('default','wp-job-portal')); ?>" border="0" />
                                                <?php } else { ?>
                                                    <a href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_common&task=makedefault&action=wpjobportaltask&for=jobtypes&id='.$row->id.$pageid)); ?>" title="<?php echo esc_html(__('no default','wp-job-portal')); ?>">
                                                        <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/notdefault.png" border="0" alt="<?php echo esc_html(__('no default','wp-job-portal')); ?>" />
                                                    </a>
                                                <?php } ?>
                                            </td>
                                            <td>
                                                <?php if ($row->isactive == 1) { ?>
                                                    <a href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_jobtype&task=unpublish&action=wpjobportaltask&wpjobportal-cb[]='.$row->id.$pageid)); ?>" title="<?php echo esc_html(__('published', 'wp-job-portal')); ?>">
                                                ...
                                                <?php } else { ?>
                                                    <a href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_jobtype&task=publish&action=wpjobportaltask&wpjobportal-cb[]='.$row->id.$pageid)); ?>" title="<?php echo esc_html(__('not published', 'wp-job-portal')); ?>">
                                            ...
                                            <td>
                                                <a class="wpjobportal-table-act-btn" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_jobtype&wpjobportallt=formjobtype&wpjobportalid='.$row->id)); ?>" title="<?php echo esc_html(__('edit', 'wp-job-portal')); ?>">
                                                ...
                                                <a class="wpjobportal-table-act-btn" href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=wpjobportal_jobtype&task=remove&action=wpjobportaltask&wpjobportal-cb[]='.$row->id),'delete-jobtype')); ?>" onclick='return confirmdelete("<?php echo esc_html(__('Are you sure to delete', 'wp-job-portal')).' ?'; ?>");' title="<?php echo esc_html(__('delete', 'wp-job-portal')); ?>">
