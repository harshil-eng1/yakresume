    ...
    case 'myjobs':
        ...
        echo '<div class="wjportal-jobs-list-btm-wrp">
                <div class="wjportal-jobs-action-wrp">';
                    ...
                    if($job->status != 4){ ?>
                    <a class="wjportal-jobs-act-btn" href="<?php echo esc_url(wp_nonce_url(wpjobportal::wpjobportal_makeUrl(array('wpjobportalme'=>'job', 'task'=>'remove', 'action'=>'wpjobportaltask', 'wpjobportal-cb[]'=>$job->id,'wpjobportalpageid'=>wpjobportal::wpjobportal_getPageid())),'delete-job')); ?>" onclick='return confirmdelete("<?php echo esc_html(__('Are you sure to delete','wp-job-portal')).' ?'; ?>");'><?php echo esc_html(__('Delete Job', 'wp-job-portal')); ?></a>
                    <?php }
                    # Copy Job --
            ...
            <div class="wjportal-jobs-list-resume-wrp">
                ...
                <div class="wjportal-jobs-list-resume-data">
                    <span class="wjportal-jobs-list-resume-tit">
                        <?php echo esc_html(__('Resume Title', 'wp-job-portal')).' : '; ?>
                    </span>
    ...
    case 'shortlistjob': ?>
        ...
        <div class="wjportal-jobs-list-btm-wrp">
            <div class="wjportal-jobs-action-wrp">
               ...
               <a class="wjportal-jobs-act-btn" href="<?php echo  esc_url(wp_nonce_url(wpjobportal::wpjobportal_makeUrl(array('wpjobportalpageid'=>wpjobportal::wpjobportal_getPageid(),'wpjobportalme'=>'shortlist', 'action'=>'wpjobportaltask', 'task'=>'removeshortlist', 'wpjobportalid'=>$job->slid)),'delete-shortlisted-job')); ?>"><?php echo esc_html(__('Delete Job', 'wp-job-portal')); ?></a><?php
                $config_array = wpjobportal::$_data['config'];
                            ...
                            if(in_array('credits', wpjobportal::$_active_addons)){ ?>
                                <?php 
                                    ...
                                    if($submission_type == 1){ ?>
                                        <?php if($applied == true){?>
                                            <a class="wjportal-jobs-act-btn" href="#" onclick="wpjobportalPopup('job_apply', '<?php echo esc_js($job->jobid); ?>')"><?php echo esc_html(__('Apply Now', 'wp-job-portal')) ?></a>
                                    <?php }else{  
                                            echo'<a class="wjportal-job-jobapply-btn wjportal-jobs-act-btn" href="#" onclick="getApplyNowByJobid('. esc_js($job->jobid) .')">'. esc_html(__("You have Already Applied",'wp-job-portal')) .' </a>';
                                        } ?>
                                ...
                                if($payment == false && $applied != true){ 
                                        ...
                                        echo'<a class="wjportal-job-jobapply-btn wjportal-jobs-act-btn" href="#" onclick="getPackagePopupJobView('. esc_js($job->jobid) .')">'. esc_html(__("You have Already Applied",'wp-job-portal')) .' </a>';  
                                     }
                                ...
                                if($applied == true){
                                 ...
                                 echo'<a class="wjportal-job-jobapply-btn wjportal-jobs-act-btn" href="#" onclick="getPackagePopupJobView('. esc_js($job->jobid) .')">'. esc_html(__("Apply On This Job",'wp-job-portal')) .' </a>';
                                    ...
                                    <a class="wjportal-jobs-act-btn" href="#" onclick="getApplyNowByJobid('<?php echo esc_js($job->jobid); ?>')"><?php echo esc_html(__('Apply Now', 'wp-job-portal')) ?></a>
                        <?php } ?>
                            
                        <?php }else{ ?>
                            <a class="wjportal-jobs-act-btn" href="#" onclick="getApplyNowByJobid('<?php echo esc_js($job->jobid); ?>',<?php echo esc_js(wpjobportal::wpjobportal_getPageid());?>);"><?php echo esc_html(__(esc_html($desc), 'wp-job-portal')) ?></a>
                        <?php } 
                    }
                } ?>
