    ...
    <div class="wjportal-main-wrapper wjportal-clearfix">
        <div class="wjportal-form-wrp wjportal-edit-profile-form">
            ...
            if( wpjobportal::$_error_flag_message == null ){ ?>
                <form id="wpjobportal-form" class="wjportal-form" method="post" action="<?php echo esc_url(wp_nonce_url(wpjobportal::wpjobportal_makeUrl(array('wpjobportalme'=>'user','action'=>'wpjobportaltask','task'=>'saveuser','wpjobportal'=>wpjobportal::wpjobportal_getPageid())),'store-user')); ?>" enctype="multipart/form-data">
