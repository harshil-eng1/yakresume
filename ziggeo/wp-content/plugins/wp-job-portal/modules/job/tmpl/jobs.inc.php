...
<?php
    ...
    $inline_js_script = "
        ...
        function getPackagePopupJobView(jobid) {
            var ajaxurl = \"". admin_url('admin-ajax.php')."\";
            jQuery.post(ajaxurl, {action: 'wpjobportal_ajax', wpjobportalme: 'job', task: 'getPackagePopupJobView', wpjobportalid: jobid, '_wpnonce':'". esc_attr(wp_create_nonce("get-package-popup-job-view"))."'}, function (data) {
                if (data) {
...
<?php
    $inline_js_script = "
        ...
        function getTokenInput(multicities) {
            ...
            var cityArray = '". admin_url("admin-ajax.php?page=wpjobportal_city&action=wpjobportaltask&task=getaddressdatabycityname")."';
