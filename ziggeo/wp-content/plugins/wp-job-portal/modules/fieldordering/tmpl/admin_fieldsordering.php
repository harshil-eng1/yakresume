        ...
        <div id="wpjobportal-head">
            ...
            <?php
                if(in_array('customfield', wpjobportal::$_active_addons)){
                    ...
                    echo '<a class="wpjobportal-add-link button" href="?page=wpjobportal_customfield&wpjobportallt=formuserfield&ff='.wpjobportal::$_data['fieldfor'].'" title='. esc_html(__('add user fields','wp-job-portal')).'>
        ...
        <div id="wpjobportal-admin-wrapper" class="p0 bg-n bs-n">
            ...
            <div id="wpjobportal-page-quick-actions">
                <a class="wpjobportal-page-quick-act-btn multioperation" message="<?php echo esc_attr(WPJOBPORTALMessages::getMSelectionEMessage()); ?>" data-for="fieldpublished" href="#" title="<?php echo esc_html(__('user publish', 'wp-job-portal')) ?>">
                    <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/control_panel/dashboard/good.png" alt="<?php echo esc_html(__('user publish', 'wp-job-portal')) ?>" />
                ...
                <a class="wpjobportal-page-quick-act-btn multioperation" message="<?php echo esc_attr(WPJOBPORTALMessages::getMSelectionEMessage()); ?>" data-for="fieldunpublished" href="#" title="<?php echo esc_html(__('user unpublish', 'wp-job-portal')) ?>">
                    <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/control_panel/dashboard/close.png" alt="<?php echo esc_html(__('user unpublish', 'wp-job-portal')) ?>" />
                ...
                <a class="wpjobportal-page-quick-act-btn multioperation" message="<?php echo esc_attr(WPJOBPORTALMessages::getMSelectionEMessage()); ?>" data-for="visitorfieldpublished" href="#" title="<?php echo esc_html(__('visitor publish', 'wp-job-portal')) ?>">
                    <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/control_panel/dashboard/good.png" alt="<?php echo esc_html(__('visitor publish', 'wp-job-portal')) ?>" />
                ...
                <a class="wpjobportal-page-quick-act-btn multioperation" message="<?php echo esc_attr(WPJOBPORTALMessages::getMSelectionEMessage()); ?>" data-for="visitorfieldunpublished" href="#" title="<?php echo esc_html(__('visitor unpublish', 'wp-job-portal')) ?>">
                    <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/control_panel/dashboard/close.png" alt="<?php echo esc_html(__('visitor unpublish', 'wp-job-portal')) ?>" />
                ...
                <a class="wpjobportal-page-quick-act-btn multioperation" message="<?php echo esc_attr(WPJOBPORTALMessages::getMSelectionEMessage()); ?>" data-for="fieldrequired" href="#" title="<?php echo esc_html(__('required', 'wp-job-portal')) ?>">
                    <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/control_panel/dashboard/good.png" alt="<?php echo esc_html(__('required', 'wp-job-portal')) ?>" />
                ...
                <a class="wpjobportal-page-quick-act-btn multioperation" message="<?php echo esc_attr(WPJOBPORTALMessages::getMSelectionEMessage()); ?>" data-for="fieldnotrequired" href="#" title="<?php echo esc_html(__('not required', 'wp-job-portal')) ?>">
                    <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/control_panel/dashboard/close.png" alt="<?php echo esc_html(__('not required', 'wp-job-portal')) ?>" />
                ...
                $inline_js_script = "
                    jQuery(document).ready(function () {
                        ...
                        jQuery('#saveordering').click(function(){
                            jQuery('#wpjobportal-list-form').attr('action','". admin_url("admin.php?page=wpjobportal&task=saveordering")."');
                            return true;
                        });
                                    ...
                                    for ($i = 0, $n = count(wpjobportal::$_data[0]); $i < $n; $i++) {
                                        ...
                                        <tr class="<?php if($sec != 'section_') echo 'sortable'; ?>" id="id_<?php echo esc_attr($row->id); ?>">
                                                ...
                                                if ($sec == 'section_') {
                                                    ...
                                                    <td>
                                                        <?php if ($row->cannotunpublish == 1) { ?>
                                                            <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/control_panel/dashboard/good.png" alt="<?php echo esc_html(__('published', 'wp-job-portal')); ?>" />
                                                        <?php
                                                            } else {
                                                                $icon_name = "close.png";
                                                                $task = "fieldpublished";
                                                        ...
                                                        <a href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_fieldordering&task='.$task.'&action=wpjobportaltask&wpjobportal-cb[]='.$row->id.$pageid.'&ff='.wpjobportal::$_data['fieldfor'])); ?>" title="<?php echo esc_attr($alt); ?>">
                                                            <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/control_panel/dashboard/<?php echo esc_attr($icon_name); ?>" alt="<?php echo esc_attr($alt); ?>" />
                                                        </a>
                                                        <?php } ?>
                                                    </td>
                                                    <td>
                                                        ...
                                                        <?php
                                                            ...
                                                            <a href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_fieldordering&task='.$task.'&action=wpjobportaltask&wpjobportal-cb[]'.$row->id.$pageid.'&ff='.wpjobportal::$_data['fieldfor'])); ?>" title="<?php echo esc_attr($visitoralt); ?>">
                                                                <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/control_panel/dashboard/<?php echo esc_attr($icon_name); ?>" alt="<?php echo esc_attr($visitoralt); ?>" />
                                                            </a>
                                                        <?php } ?>
                                                    </td>
                                                    <td>
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <td>
                                                    <?php if ($row->cannotunpublish == 1) { ?>
                                                        <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/control_panel/dashboard/good.png" title="<?php echo esc_html(__('published', 'wp-job-portal')); ?>" />
                                                    <?php
                                                        } else {
                                                            $icon_name = "close.png";
                                                            $task = "fieldpublished";
                                                ...
                                                <td>
                                                    <?php if ($row->cannotunpublish == 1) { ?>
                                                        <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/control_panel/dashboard/good.png" title="<?php echo esc_html(__('Un published', 'wp-job-portal')); ?>" />
                                                    <?php
                                                        } else {
                                                            $icon_name = "close.png";
                                                            $task = "visitorfieldpublished";
                                                ...
                                                <td>
                                                    <?php if ($row->sys == 1 || $row->field == 'termsandconditions') { ?>
                                                        <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/control_panel/dashboard/good.png" title="<?php echo esc_html(__('required', 'wp-job-portal')); ?>" />
                                                        <?php
                                                    } else {
                                                        $icon_name = "close.png";
                                                        $task = "fieldrequired";
                                                    ...
                                                    <a href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_fieldordering&task='.$task.'&action=wpjobportaltask&wpjobportal-cb[]='.$row->id.$pageid.'&ff='.wpjobportal::$_data['fieldfor'])); ?>" title="<?php echo esc_attr($requiredalt); ?>">
                                                        <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/control_panel/dashboard/<?php echo esc_attr($icon_name); ?>" alt="<?php echo esc_attr($requiredalt); ?>" />
                                                    </a>
                                                    <?php } ?>
                                                </td>
                                                <td>
                                                    <a class="wpjobportal-table-act-btn" href="<?php echo esc_url(admin_url("admin.php?page=wpjobportal_fieldordering&wpjobportallt=formuserfield&ff=".wpjobportal::$_data['fieldfor']."&wpjobportalid=".$row->id)); ?>" title="<?php echo esc_html(__('edit', 'wp-job-portal')); ?>">
