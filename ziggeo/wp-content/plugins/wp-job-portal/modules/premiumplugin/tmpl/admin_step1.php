                            ...
                            <form id="wpjobportalfrom" action="<?php echo admin_url('admin.php?page=wpjobportal_premiumplugin&task=verifytransactionkey&action=wpjobportaltask'); ?>" method="post">
                                <div class="wpjobportal-addon-installer-left-section-wrap" >
                                    ...
                                    <div class="wpjobportal-addon-installer-left-description" >
                                        <?php echo __("WP Job Portal is a trusted open source ticket system. WP Job Portal is a simple, easy to use, web-based customer support system. Users can create a ticket from the front-end. WP Job Portal comes packed with lot features than most of the expensive(and complex) support ticket system on the market. The best part is, It completely free.","wp-job-portal"); ?>
                                    </div>
                                </div>
