...
function WPJP_PrintAddoneStatus($name, $title, $img, $version, $status, $cdnavailableversion = ''){
    ...
    if ($status == 'update_available') {
        ...
        $btntxt = 'Update Now';
        $btnlink = 'id="wpjp-admin-addons-update" data-for="'.$name.'"';
    ...
    <div class="'.$wrpclass.'" id="'.$name.'">
        <div class="wpjp-addon-status-image-wrp">
            <img alt="Addone image" src="'.esc_url(WPJOBPORTAL_PLUGIN_URL).'includes/images/control_panel/dashboard/addons/'.$img.'" />
        </div>
