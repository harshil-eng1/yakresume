                                        ...
                                        <div class="wpjobportal-config-row">
                                            ...
                                            <div class="wpjobportal-config-value">
                                                ...
                                                <div class="wpjobportal-config-description">
                                                    <?php echo esc_html(__('System will upload all user files in this folder', 'wp-job-portal')); echo '<br/><b>"'.WPJOBPORTAL_PLUGIN_PATH.wpjobportal::$_data[0]['data_directory'].'"</b>'; ?>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div id="visitor_setting" class="wpjobportal-hide-config">
                                ...
                                <div class="tabInner">
                                    ...
                                    <div id="captcha_setting" class="wpjobportal_gen_body">
                                        ...
                                        <div class="wpjobportal-config-row google-recaptcha">
                                            <div class="wpjobportal-config-title">
                                                <?php echo esc_html(__('Google reCaptcha Public Key', 'wp-job-portal')); ?>
                                            </div>
                                            <div class="wpjobportal-config-value">
                                                ...
                                                <div class="wpjobportal-config-description">
                                                    <?php echo esc_html(__('Enter the Google reCaptcha public key from','wp-job-portal')).'https://www.google.com/recaptcha/admin'; ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
