...
<?php
    ...
    $inline_js_script = "
        ...
        function getPackagePopup(companyid) {
            var ajaxurl = \"". admin_url('admin-ajax.php') ."\";
            jQuery.post(ajaxurl, {action: 'wpjobportal_ajax', wpjobportalme: 'featuredcompany', task: 'getPackagePopupForFeaturedCompany', wpjobportalid: companyid, '_wpnonce':'". esc_attr(wp_create_nonce("get-package-popup-for-featured-company"))."'}, function (data) {
                if (data) {
