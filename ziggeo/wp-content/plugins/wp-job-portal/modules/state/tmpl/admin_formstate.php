        ...
        <div id="wpjobportal-admin-wrapper">
            <form id="wpjobportal-form" class="wpjobportal-form" method="post" action="<?php echo admin_url("admin.php?page=wpjobportal_state&task=savestate"); ?>">
                ...
                <div class="wpjobportal-form-button">
                    <a id="form-cancel-button" class="wpjobportal-form-cancel-btn" href="<?php echo admin_url('admin.php?page=wpjobportal_state&countryid='.get_option('wpjobportal_countryid_for_stateid')); ?>" title="<?php echo esc_html(__('cancel', 'wp-job-portal')); ?>">
