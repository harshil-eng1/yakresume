...
<?php
       ...
       var maindivoffsettop = 0;
        ...
        jQuery(document).ready(function () {
            ...
            jQuery('body').delegate('span.wpjobportal-resume-moreoptiontitle', 'click', function(e){
                ...
                if (jQuery('div.wpjobportal-resume-moreoption').is(':hidden')) {
                    var srcimg = '". WPJOBPORTAL_PLUGIN_URL . "includes/images/resume/up.png';
                } else{
                    var srcimg = '". WPJOBPORTAL_PLUGIN_URL . "includes/images/resume/down.png';
                }
        ...
        function showResumeFilesArrayPopup(){
            ...
            for (i = 0; i < resumefiles.length; i++){
                ...
                if (obj.canupload == 1){
                    var mHTML = '<a href=\"javascript:void(0);\" onclick=\"removeFileByIndex(' + i + ');\" class=\"file\"><span class=\"filename\">' + obj.file.name + '</span><span class=\"fileext\"> </span><img class=\"filedownload\" src=\"". WPJOBPORTAL_PLUGIN_URL."includes/images/resume/cancel.png\" /></a>';
    ...
    function submitresume(){
        ...
        function submitresumesection(section, sectionid){
            ...
            formdata.append('_wpnonce', '". esc_attr(wp_create_nonce("save-resume-section-ajax"))."');
            if (section == 'resume'){
        ...
        jQuery(document).ready(function(){
            ...
            if (print_link) {
                ...
                $inline_js_script .= "
                var href = \"". wpjobportal::wpjobportal_makeUrl(array('wpjobportalme'=>'resume', 'wpjobportallt'=>'printresume', 'wpjobportalid'=>$resumeid, 'wpjobportalpageid'=>wpjobportal::wpjobportal_getPageid()))."\";
        ...
        function getTokenInputTags(multitags) {
            var tagArray = \"". admin_url('admin.php?page=wpjobportal_tag&tagfor=1&action=wpjobportaltask&task=gettagsbytagname')."\";
