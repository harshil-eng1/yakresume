...
?>
	...
	<span class="buttonu"><?php echo esc_html(__(esc_html($myresume->jobtypetitle),'wp-job-portal')); ?></span><span class="datecreated"><?php echo esc_html(__('Created', 'wp-job-portal')) . ': ' . esc_html(date_i18n($dateformat, strtotime($myresume->created))); ?></span>
	</div>
	...
	<div class="custom-field-wrapper">
	    <span class="js-bold"><?php echo esc_html(__(esc_html(wpjobportal::$_data['fields']['email_address']), 'wp-job-portal')) . ': '; ?></span>
	...
	<div class="custom-field-wrapper">
	    ...
	    <?php
	        ...
	        echo esc_html(__(esc_html(wpjobportal::$_data['fields']['desired_salary']), 'wp-job-portal')) . ': '; ?>
	    </span>
	</div>
	<div class="custom-field-wrapper">
	    <span class="js-bold"><?php echo esc_html(__(esc_html(wpjobportal::$_data['fields']['job_category']), 'wp-job-portal')) . ': '; ?></span>
	    <span class="get-text"><?php echo esc_html(__(esc_html($myresume->cat_title),'wp-job-portal')); ?></span>
	</div>
	<div class="custom-field-wrapper">
	    <span class="js-bold">
	    <?php
	        ...
	        echo esc_html(__(esc_html(wpjobportal::$_data['fields']['total_experience']), 'wp-job-portal')) . ': '; ?></span>
	    <span class="get-text"><?php echo esc_html(__(esc_html($myresume->total_experience),'wp-job-portal')); ?></span>
	</div>
	<?php
	// custom fields
