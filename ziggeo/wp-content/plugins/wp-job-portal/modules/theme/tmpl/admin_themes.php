                ...
                <div class="wjportal-jobs-list">
                    <div class="wjportal-jobs-list-top-wrp">
                        <div class="wjportal-jobs-logo">
                            <a href="#">
                                <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>/includes/images/default_logo.png" alt="<?php echo esc_html(__('Company logo','wp-job-portal')); ?>">
                            </a>
                        </div>
...
<?php
    ...
    $inline_js_script = "
        jQuery(document).ready(function () {
            makeColorPicker('". esc_js(wpjobportal::$_data[0]['color1'])."', '". esc_js(wpjobportal::$_data[0]['color2'])."', '". esc_js(wpjobportal::$_data[0]['color3'])."', '". esc_js(wpjobportal::$_data[0]['color4'])."', '". esc_js(wpjobportal::$_data[0]['color5'])."', '". esc_js(wpjobportal::$_data[0]['color6'])."', '". esc_js(wpjobportal::$_data[0]['color7'])."', '". esc_js(wpjobportal::$_data[0]['color8'])."');
