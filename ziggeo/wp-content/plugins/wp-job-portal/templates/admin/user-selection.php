...
<div id="popup_main" style="display:none;">
    <span class="popup-top">
    	...
    	<img id="popup_cross" alt="<?php echo esc_html(__('popup cross','wp-job-portal')); ?>" src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/popup-close.png">
    </span>
    ...
    $inline_js_script = "
        function updateuserlist(pagenum) {
            var username = jQuery('input#uname').val();
                ...
                jQuery.post(ajaxurl, {action: 'wpjobportal_ajax', wpjobportalme: 'user', task: 'getuserlistajax',name: name, uname: username, email: emailaddress,userlimit: pagenum, listfor: 1, '_wpnonce':'". esc_attr(wp_create_nonce("get-user-list-ajax"))."' }, function (data) {
                if (data) {
