                ...
                if (isset(wpjobportal::$_data[0]) && !empty(wpjobportal::$_data[0])) {
                    foreach (wpjobportal::$_data[0] AS $jobsBycity) {
                        ...
                        <div class="wjportal-type-wrapper" style="width:<?php echo esc_attr($width); ?>%;">
                            <a href="<?php echo esc_url(wpjobportal::wpjobportal_makeUrl(array('wpjobportalme'=>'job', 'wpjobportallt'=>'jobs', 'city'=>$jobsBycity->cityid))); ?>" title="<?php echo wpjobportal::wpjobportal_getVariableValue($jobsBycity->cityname); ?>">
