...
foreach($fields AS $field){
   ...
   switch ($field->field) {
        ...
        case 'stoppublishing':
            ...
            $content = WPJOBPORTALformfield::text('stoppublishing', isset($job->stoppublishing) ?  date(wpjobportal::$_config->getConfigValue('date_format'), strtotime($job->stoppublishing))  : '', array('class' => 'custom_date one wjportal-form-date-field','placeholder'=>wpjobportal::wpjobportal_getVariableValue($field->placeholder),'data-validation'=>$required,'autocomplete'=>'off'));
