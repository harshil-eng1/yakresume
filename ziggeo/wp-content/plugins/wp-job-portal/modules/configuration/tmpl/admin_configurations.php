                                    ...
                                    <div id="offline" class="wpjobportal_gen_body">
                                        ...
                                        <div class="wpjobportal-config-row">
                                            ...
                                            <div class="wpjobportal-config-value full-width">
                                                <?php echo wp_kses_post(wp_editor(wpjobportal::$_data[0]['offline_text'], 'offline_text', array('media_buttons' => false))); ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="emp_visitorlinks" class="wpjobportal_gen_body">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <div class="wpjobportal-config-row">
                                                ...
                                                <div class="wpjobportal-config-value">
                                                    <?php echo wp_kses(WPJOBPORTALformfield::select('vis_temp_employer_dashboard_stats_graph', $showhide, wpjobportal::$_data[0]['temp_employer_dashboard_stats_graph']),WPJOBPORTAL_ALLOWED_TAGS); ?>
                                                </div>
                                            </div>
                                            <div class="wpjobportal-config-row">
                                                <div class="wpjobportal-config-title">
                                                ...
                                                <div class="wpjobportal-config-value">
                                                    <?php echo wp_kses(WPJOBPORTALformfield::select('vis_temp_employer_dashboard_useful_links', $showhide, wpjobportal::$_data[0]['temp_employer_dashboard_useful_links']),WPJOBPORTAL_ALLOWED_TAGS); ?>
                                                </div>
                                            </div>
                                            <div class="wpjobportal-config-row">
                                                <div class="wpjobportal-config-title">
                                                ...
                                                <div class="wpjobportal-config-value">
                                                    <?php echo wp_kses(WPJOBPORTALformfield::select('vis_temp_employer_dashboard_applied_resume', $showhide, wpjobportal::$_data[0]['temp_employer_dashboard_applied_resume']),WPJOBPORTAL_ALLOWED_TAGS); ?>
                                                </div>
                                            </div>
                                            <div class="wpjobportal-config-row">
                                                <div class="wpjobportal-config-title">
                                                ...
                                                <div class="wpjobportal-config-value">
                                                    <?php echo wp_kses(WPJOBPORTALformfield::select('vis_temp_employer_dashboard_saved_search', $showhide, wpjobportal::$_data[0]['temp_employer_dashboard_saved_search']),WPJOBPORTAL_ALLOWED_TAGS); ?>
                                                </div>
                                            </div>
                                            <?php if(in_array('credits', wpjobportal::$_active_addons)){ ?>
                                                <div class="wpjobportal-config-row">
                                                    ...
                                                    <div class="wpjobportal-config-value">
                                                        <?php echo wp_kses(WPJOBPORTALformfield::select('vis_temp_employer_dashboard_purchase_history', $showhide, wpjobportal::$_data[0]['temp_employer_dashboard_purchase_history']),WPJOBPORTAL_ALLOWED_TAGS); ?>
                                                    </div>
                                                </div>
                                            <?php } ?>
                                            <div class="wpjobportal-config-row">
                                                ...
                                                <div class="wpjobportal-config-value">
                                                    <?php echo wp_kses(WPJOBPORTALformfield::select('vis_temp_employer_dashboard_newest_resume', $showhide, wpjobportal::$_data[0]['temp_employer_dashboard_newest_resume']),WPJOBPORTAL_ALLOWED_TAGS); ?>
                                                </div>
                                            </div>
                                        <?php } ?>
                                        <h3 class="wpjobportal-config-heading-main wpjobportal-inner-heading">
                                ...
                                <div class="tabInner">
                                    <?php if(in_array('credits', wpjobportal::$_active_addons)){ ?>
                                        ...
                                        <div id="paid_submission" class="wpjobportal_gen_body">
                                            ...
                                            <div class="wpjobportal-config-row">
                                                <div class="wpjobportal-config-title">
                                                    <?php echo __('Company View Contact Detail  submission (only for "per listing" mode)', 'wp-job-portal'); ?>
                                                </div>
                                                <div class="wpjobportal-config-value wpjobportal-config-2-fields">
                                                    <div class="wpjobportal-config-inner-fields">
