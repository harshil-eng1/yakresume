                                    ...
                                    for ($i = 0, $n = count(wpjobportal::$_data[0]); $i < $n; $i++) {
                                        ...
                                        <tr id="id_<?php echo esc_attr($row->id);?>">
                                            ...
                                            <td class="wpjobportal-text-left">
                                                <a href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_currency&wpjobportallt=formcurrency&wpjobportalid='.$row->id)); ?>" title="<?php echo esc_html(__('title', 'wp-job-portal')); ?>">
                                            ...
                                            <td>
                                                <?php if ($row->default == 1) { ?>
                                                    <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/default.png" alt="Default" border="0" alt="<?php echo esc_html(__('default', 'wp-job-portal')); ?>" />
                                                <?php } else { ?>
                                                    <a href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_common&task=makedefault&action=wpjobportaltask&for=currencies&id='.$row->id.$pageid)); ?>" title="<?php echo esc_html(__('not default', 'wp-job-portal')); ?>">
                                                        <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/notdefault.png" border="0" alt="<?php echo esc_html(__('not default', 'wp-job-portal')); ?>" />
                                                    </a>
                                                <?php } ?>
                                            </td>
                                            <td>
                                                <?php if ($row->status == 1) { ?>
                                                    <a href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_currency&task=unpublish&action=wpjobportaltask&wpjobportal-cb[]='.$row->id.$pageid)); ?>" title="<?php echo esc_html(__('published', 'wp-job-portal')); ?>">
                                                ...
                                                <?php } else { ?>
                                                    <a href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_currency&task=publish&action=wpjobportaltask&wpjobportal-cb[]='.$row->id.$pageid)); ?>" title="<?php echo esc_html(__('not published', 'wp-job-portal')); ?>">
                                            ...
                                            <td>
                                                <a class="wpjobportal-table-act-btn" href="<?php echo esc_url(admin_url('admin.php?page=wpjobportal_currency&wpjobportallt=formcurrency&wpjobportalid='.$row->id)); ?>" title="<?php echo esc_html(__('edit', 'wp-job-portal')); ?>">
                                                ...
                                                <a class="wpjobportal-table-act-btn" href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=wpjobportal_currency&task=remove&action=wpjobportaltask&wpjobportal-cb[]='.$row->id),'delete-currency')); ?>" onclick='return confirmdelete("<?php echo esc_html(__('Are you sure to delete', 'wp-job-portal')).' ?'; ?>");' title="<?php echo esc_html(__('delete', 'wp-job-portal')); ?>">
