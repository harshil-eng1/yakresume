        ...
        <div class="js-data">
            <div class="left">
                ...
                <?php if($jobfields['jobcategory']->showonlisting == 1){ ?>
                    <span class="get-text"><?php echo  esc_html(__(esc_html($job->cat_title),'wp-job-portal')); ?></span>
                <?php } ?>
            ...
            <div class="right">
                <div class="js-col-xs-12 js-col-sm-12 js-col-md-12 js-fields for-rtl joblist-datafields">
                    <span class="js-type" style="color:#fff;padding:3px;background:<?php echo esc_attr($job->jobtypecolor); ?>;"><?php echo esc_html(__(esc_html($job->jobtypetitle),'wp-job-portal')); ?></span>
                </div>
                ...
                <?php } ?>
                <div class="js-col-xs-12 js-col-sm-12 js-col-md-12 js-fields for-rtl joblist-datafields">
                    <?php echo esc_html(human_time_diff(strtotime($job->created))).' '.esc_html(__("Ago",'wp-job-portal')); ?>
                </div>
            </div>
