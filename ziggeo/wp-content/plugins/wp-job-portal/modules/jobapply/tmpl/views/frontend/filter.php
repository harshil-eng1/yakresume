...
<?php
    ...
    switch ($layout) {
	    case 'myjobfilter':
            ...
            $html.= '<a href='. wpjobportal::wpjobportal_makeUrl(array('wpjobportalme'=>'job', 'wpjobportallt'=>'myjobs','sortby' => wpjobportal::$_sortlinks['newest'], 'wpjobportalpageid'=>wpjobportal::wpjobportal_getPageid())) .' class='.$select.'>';
            $html.= '<img src='.WPJOBPORTAL_PLUGIN_URL . "includes/images/" . $img .' alt='.esc_html(__('sort','wp-job-portal')).'>';
            $html.= '</a>
                  </div>';
            break;
