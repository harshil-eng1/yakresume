    ...
    <div id="wpjobportaladmin-data">
        ...
        <div id="wpjobportal-admin-wrapper" class="p0 bg-n bs-n">
            ...
            <form class="wpjobportal-filter-form slug-configform" name="wpjobportalform" id="conwpjobportalform" method="post" action="<?php echo admin_url("admin.php?page=wpjobportal_slug&task=savehomeprefix"); ?>">
                <?php echo wp_kses(WPJOBPORTALformfield::text('prefix', wpjobportal::$_configuration['home_slug_prefix'], array('class' => 'inputbox wpjobportal-form-input-field', 'placeholder' => esc_html(__('Home Slug','wp-job-portal')).' '. esc_html(__('Prefix', 'wp-job-portal')))),WPJOBPORTAL_ALLOWED_TAGS); ?>
            ...
            <form class="wpjobportal-filter-form slug-configform" name="wpjobportalform" id="conwpjobportalform" method="post" action="<?php echo admin_url("admin.php?page=wpjobportal_slug&task=saveprefix"); ?>">
                <?php echo wp_kses(WPJOBPORTALformfield::text('prefix', wpjobportal::$_configuration['slug_prefix'], array('class' => 'inputbox wpjobportal-form-input-field', 'placeholder' => esc_html(__('Slug','wp-job-portal')).' '. esc_html(__('Prefix', 'wp-job-portal')))),WPJOBPORTAL_ALLOWED_TAGS); ?>
                <?php echo wp_kses(WPJOBPORTALformfield::submitbutton('btnsubmit', esc_html(__('Save', 'wp-job-portal')), array('class' => 'button wpjobportal-form-search-btn')),WPJOBPORTAL_ALLOWED_TAGS); ?>
                <?php echo wp_kses(WPJOBPORTALformfield::hidden('form_request', 'wpjobportal'),WPJOBPORTAL_ALLOWED_TAGS); ?>
                <div class="wpjobportal-form-help-text">
                    <img src="<?php echo WPJOBPORTAL_PLUGIN_URL; ?>includes/images/view-job-information.png" />
            ...
            <form class="wpjobportal-filter-form" name="wpjobportalform" id="wpjobportalform" method="post" action="<?php echo admin_url("admin.php?page=wpjobportal_slug"); ?>">
                <?php echo wp_kses(WPJOBPORTALformfield::text('slug', wpjobportal::$_data['slug'], array('class' => 'inputbox wpjobportal-form-input-field', 'placeholder' => esc_html(__('Search By Slug', 'wp-job-portal')))),WPJOBPORTAL_ALLOWED_TAGS); ?>
                                    ...
                                    foreach (wpjobportal::$_data[0] as $row){
                                        ...
                                        <tr>
                                            ...
                                            <td class="wpjobportal-text-left">
                                                <?php echo esc_html(__(esc_html($row->description),'wp-job-portal'));?>
                                            </td>
                                            <td>
