    ...
    $inline_js_script = "
        ...
        jQuery(document).ready(function () {
         ...
         function getPackagePopup(resumeid) {
            var ajaxurl = \"". admin_url('admin-ajax.php') ."\";
            jQuery.post(ajaxurl, {action: 'wpjobportal_ajax', wpjobportalme: 'multiresume', task: 'getPackagePopupForFeaturedResume', wpjobportalid: resumeid, '_wpnonce':'". esc_attr(wp_create_nonce("get-package-popup-for-featured-resume")).">'}, function (data) {
                if (data) {
        ...
        function addBadgeToObject(cid, specialtype, object,themecall) {
            ...
            if(1 ==common.theme_chk_number){
                ...
                html += object.expiry;
                html += '<img src=\"". WPJOBPORTAL_PLUGIN_URL."includes/images/bottom-tool-tip.png\" alt=\"downhover-part\">';
                html += '</span>';
                html += '</span>';
