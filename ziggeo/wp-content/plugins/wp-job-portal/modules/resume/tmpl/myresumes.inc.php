...
<?php
    ...
    function changeCombo() {
     ...
     function getPackagePopup(resumeid) {
        var ajaxurl = \"". admin_url('admin-ajax.php') ."\";
        jQuery.post(ajaxurl, {action: 'wpjobportal_ajax', wpjobportalme: 'featureresume', task: 'getPackagePopupForFeaturedResume', wpjobportalid: resumeid, '_wpnonce':'". esc_attr(wp_create_nonce("get-package-popup-for-featured-resume"))."'}, function (data) {
            if (data) {
